...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, index_1.print)('Started uploading images to IPFS...');
        const imagesIpfsHash = yield (0, metadata_1.uploadFolderToIPFS)(imagesFolderPath);
        (0, index_1.print)(`Successfully uploaded the pictures to ipfs: https://gateway.pinata.cloud/ipfs/${imagesIpfsHash}`);
        (0, index_1.print)('Started uploading metadata files to IPFS...');
        ...
        (0, index_1.print)(`Successfully uploaded the metadata to ipfs: https://gateway.pinata.cloud/ipfs/${metadataIpfsHash}`);
        (0, index_1.print)('Start deploy of nft collection...');
        ...
        (0, index_1.print)(`Collection deployed: ${collection.address}`);
        ...
        yield (0, delay_1.waitSeqno)(seqno, wallet);
        (0, index_1.print)(`Balance top-upped`);
        for (const file of files) {
            (0, index_1.print)(`Start deploy of ${index + 1} NFT`);
            const mintParams = {
                queryId: 0,
            ...
            (0, index_1.print)(`Successfully deployed ${index + 1} NFT`);
            yield (0, delay_1.waitSeqno)(seqno, wallet);
            index++;
        }
        (0, index_1.print)('Start deploy of new marketplace  ');
        const marketplace = new NftMarketplace_1.NftMarketplace(wallet.contract.address);
        seqno = yield marketplace.deploy(wallet);
        yield (0, delay_1.waitSeqno)(seqno, wallet);
        (0, index_1.print)('Successfully deployed new marketplace');
